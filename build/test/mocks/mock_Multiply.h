...
#define multiply_ExpectAndReturn(value1, cmock_retval) multiply_CMockExpectAndReturn(__LINE__, value1, cmock_retval)
void multiply_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, int value1, int cmock_to_return);
typedef int (* CMOCK_multiply_CALLBACK)(int value1, int cmock_num_calls);
