...
int multiply(int value1)
{
  ...
  if (Mock.multiply_CallbackFunctionPointer != NULL)
  {
    return Mock.multiply_CallbackFunctionPointer(value1, Mock.multiply_CallbackCalls++);
  }
...
void CMockExpectParameters_multiply(CMOCK_multiply_CALL_INSTANCE* cmock_call_instance, int value1)
{
...
void multiply_CMockExpectAndReturn(UNITY_LINE_TYPE cmock_line, int value1, int cmock_to_return)
{
  CMOCK_MEM_INDEX_TYPE cmock_guts_index = CMock_Guts_MemNew(sizeof(CMOCK_multiply_CALL_INSTANCE));
  CMOCK_multiply_CALL_INSTANCE* cmock_call_instance = (CMOCK_multiply_CALL_INSTANCE*)CMock_Guts_GetAddressFor(cmock_guts_index);
  UNITY_TEST_ASSERT_NOT_NULL(cmock_call_instance, cmock_line, "CMock has run out of memory. Please allocate more.");
  ...
  CMockExpectParameters_multiply(cmock_call_instance, value1);
  cmock_call_instance->ReturnVal = cmock_to_return;
}
